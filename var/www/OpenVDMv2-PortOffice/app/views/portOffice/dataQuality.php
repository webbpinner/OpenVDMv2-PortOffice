...
?>
                                                <a href='<?php echo DIR; ?>dataQualityShowFileStats/<?php echo $data['dataObjects'][$i][$j]['raw_data']; ?>' class='btn btn-xs btn-default'>Show</a>
<?php
            } else {
?>
                                                <a href='<?php echo DIR; ?>dataQualityShowFileStats/<?php echo $data['dataObjects'][$i][$j]['raw_data']; ?>' class='btn btn-xs btn-default disabled'>Show</a>
<?php
            }
?>
                                            </td>
...
<?php
        ...
        if($statsAvailable) {
?>
                                                <a href='<?php echo DIR; ?>dataQualityShowDataTypeStats/<?php echo $data['dataTypes'][$i]; ?>' class='btn btn-xs btn-default'>Show Totals</a>
<?php
        } else {
?>
                                                <a href='<?php echo DIR; ?>dataQualityShowDataTypeStats/<?php echo $data['dataTypes'][$i]; ?>' class='btn btn-xs btn-default disabled'>Show Totals</a>
<?php
        }
?>
                                            </td>
