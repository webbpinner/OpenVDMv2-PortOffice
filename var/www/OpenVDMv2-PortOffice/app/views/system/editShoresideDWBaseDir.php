            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo Form::open(array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group"><label>Filesystem Directory containing cruise data:</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'shoresideDWBaseDir', 'value'=>$data['shoresideDWBaseDir']));?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
