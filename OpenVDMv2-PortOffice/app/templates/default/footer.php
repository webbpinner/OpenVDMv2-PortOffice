...
$hooks = Hooks::get();
?>
    <footer class="text-muted pull-right" style="padding: 15px"><a href="http://www.oceandatarat.org/?page_id=1123">OpenVDMv2</a> is licensed under the <a href="http://www.gnu.org/licenses/gpl-3.0.html">GPLv3</a> public license</footer>

<!-- JS -->
<script type="text/javascript">
    var siteRoot = "<?php echo DIR ?>";
    var cruiseID = "<?php echo Session::get('cruiseID'); ?>";
<?php
    if(isset($data['shoresideDWApacheDir'])) {
?>
    var cruiseDataDir = "<?php echo $data['shoresideDWApacheDir'];?>";
<?php
    }
?>
</script>
